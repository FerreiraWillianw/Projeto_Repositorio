...
export const profileData = {
  ...
  skills: [
    { name: "Power BI", icon: "BarChart3", description: "Criação de dashboards interativos e análise de BI.", pontosFortes:"O Power BI se destaca pela capacidade de unir variedades e modelos diferentes de fontes de dados, automatizando relatórios, criando permissões de visualização e também velocidade na entrega de insights valiosos para o negócio.", uso:"É a solução ideal quando a necessidade é transformar dados brutos em dashboards dinâmicos e relatórios compartilháveis, permitindo que equipes tomem decisões informadas com base em informações consolidadas. É particularmente útil em cenários que exigem centralização de dados dispersos, governança de relatórios, distribuição segura via web/SharePoint/Teams e atualização contínua sem intervenção manual, oferecendo uma experiência acessível a usuários não técnicos." },
...
export const projectsData = [
...

  {
    ...
    image: FotoDashAmazon,
    powerbiUrl: "https://vendas-amazon-india.streamlit.app/?embed=true",
...

  {
    ...
    highlights: [
      ...
      "Distribuição de notas por Índice de Saúde Mental", 
      "Desmistificação do impacto de telas e atividades extras (-0.17)"
    ]
  }
];